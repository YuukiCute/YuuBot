...
async function rankc(data, api) {
	...
	var fontcl =
		global.data.rankcard[data.senderID].fontColor.toLowerCase() == 'theme'
			? themecl
			: global.data.rankcard[data.senderID].fontColor;
	...
	let tokenFB = '1073911769817594|aa417da57f9e260d1ac1ec4530b417de';
	...
	try {
		...
		var avatar = await jimp.read(
			`https://graph.facebook.com/${data.senderID}/picture?height=85&width=85`
		);
	}
	avatar.circle();
